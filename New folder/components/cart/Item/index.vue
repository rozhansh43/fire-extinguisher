  ...
  <div v-if="item && product" class="px-4 pt-4 pb-2">
    <b-row>
      ...
      <b-col>
        ...
        >
          <h5 v-if="product" class="font-weight-normal mb-4">
          ...
          <transition name="slide">
            <b-alert v-if="hasChange" show variant="warning" class="p-3 mb-4">
              <change :item="item" no-product-title/>
            </b-alert>
          </transition>
            ...
            <b-col>
              ...
              <b-row class="align-items-center mb-3">
                ...
                <b-col cols="6" md="4">
                  <quantity
                    :item-id="item.id"
                    :min="articlePackage.minOq"
                    :max="articlePackage.maxOq"
              ...
              <div class="text-muted mb-3">
                <b-btn variant="link" class="p-0 inherited-link" @click="emitRemove">
                  <font-awesome-icon
                    icon="trash-alt"
...
<script>
import Change from '@/components/cart/changes/Item'
...
export default {
  ...
  computed: {
    ...
    hasChange () {
      return this.item.change && this.item.change.type
    }
  },
  methods: {
    getProductPath () {
    ...
    emitRemove () {
      vm.$emit('removeCartItem', this.item.id)
    }
  }
}
</script>
